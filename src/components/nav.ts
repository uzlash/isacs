...
export const NAV: NavSection[] = [
  {
    ...
    items: [
      ...
      { id: "access", label: "Access Control Nodes", href: "/access", icon: DoorOpen },
      { id: "acms", label: "Access Control Modules", href: "/acms", icon: Cpu },
      { id: "map", label: "Facility Map", href: "/map", icon: Map },
