...
export const VIEW_TITLES: Record<string, [string, string]> = {
  ...
  access: ["Access Control Nodes", "Node hierarchy · cards · live checkpoint engine"],
  acms: ["Access Control Modules", "ACM reader devices · connectivity · secret rotation"],
  map: ["Facility Map", "KML layers · composite facility map"],
